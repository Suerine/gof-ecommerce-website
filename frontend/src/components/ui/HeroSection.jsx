...
function HeroSection() {
  ...
  // Function to calculate mouse-based parallax transforms
  const getMouseParallaxTransform = (elementData) => {
    const { speedx = 0, speedy = 0, speedz = 0, rotation = 1 } = elementData;
    
    // Calculate zValue based on mouse position relative to element
  ...
  // Background elements with new positioning data
  const backgroundElements = [
    // Field background
    {
      src: fieldSlate,
      className: "parrallax bg-img",
      alt: "Football field",
      data: { 
        speedx: 0.01, speedy: 0.01, speedz: 0.1, rotation: 0.1,
        leftPercent: 50, topPercent: 50
      }
    },
    // Fog layers
    {
      src: fog7,
      className: "parrallax fog_7",
      alt: "Fog layer 7",
      data: { 
        speedx: 0.027, speedy: 0.032, speedz: 0.63, rotation: 0.52,
        leftPercent: 30.83, topPercent: 37.66
      }
    },
    {
      src: fog6,
      className: "parrallax fog_6",
      alt: "Fog layer 6",
      data: { 
        speedx: 0.025, speedy: 0.0538, speedz: 0.72, rotation: 0.62,
        leftPercent: 51.39, topPercent: 37.66
      }
    },
    {
      src: fog5,
      className: "parrallax fog_5",
      alt: "Fog layer 5",
      data: { 
        speedx: 0.059, speedy: 0.0705, speedz: 0.56, rotation: 0.42,
        leftPercent: 50.07, topPercent: 48.77
      }
    },
    {
      src: fog4,
      className: "parrallax fog_4",
      alt: "Fog layer 4",
      data: { 
        speedx: 0.011, speedy: 0.044, speedz: 0.432, rotation: 0.53,
        leftPercent: 50.07, topPercent: 37.66
      }
    },
    {
      src: fog3,
      className: "parrallax fog_3",
      alt: "Fog layer 3",
      data: { 
        speedx: 0.0135, speedy: 0.098, speedz: 0.643, rotation: 0.63,
        leftPercent: 21.39, topPercent: 58.77
      }
    },
    {
      src: fog2,
      className: "parrallax fog_2",
      alt: "Fog layer 2",
      data: { 
        speedx: 0.065, speedy: 0.0318, speedz: 0.92, rotation: 0.35,
        leftPercent: 53.89, topPercent: 37.66
      }
    },
    {
      src: sunRays,
      className: "parrallax sun_rays",
      alt: "Sun rays",
      data: { 
        speedx: 0.015, speedy: 0.015, speedz: 0.2, rotation: 0.2,
        leftPercent: 85, topPercent: -0.34
      }
    },
    {
      src: blackShadow,
      className: "parrallax black_shadow",
      alt: "Shadow overlay",
      data: { 
        speedx: 0.01, speedy: 0.01, speedz: 0.1, rotation: 0.1,
        leftPercent: 50, topPercent: 100
      }
    },
    {
      src: fog1,
      className: "parrallax fog_1",
      alt: "Fog layer 1",
      data: { 
        speedx: 0.026, speedy: 0.031, speedz: 0.5, rotation: 0.40,
        leftPercent: 50, topPercent: 55
      }
    },
  ];

  // Players with new positioning data
  const players = [
    {
      src: ronaldinho,
      className: "parrallax ronaldinho",
      alt: "Ronaldinho",
      data: { 
        speedx: 0.0895, speedy: 0.0204, speedz: 0.82, rotation: 0.78,
        leftPercent: 11.39, topPercent: 43.66
      }
    },
    {
      src: pele,
      className: "parrallax pele",
      alt: "Pelé",
      data: { 
        speedx: 0.045, speedy: 0.0654, speedz: 0.72, rotation: 0.53,
        leftPercent: 32.39, topPercent: 81.11
      }
    },
    {
      src: messi,
      className: "parrallax messi",
      alt: "Lionel Messi",
      data: { 
        speedx: 0.0925, speedy: 0.047, speedz: 0.89, rotation: 0.90,
        leftPercent: 47.39, topPercent: 61.11
      }
    },
    {
      src: maradona,
      className: "parrallax maradona",
      alt: "Maradona",
      data: { 
        speedx: 0.059, speedy: 0.023, speedz: 0.62, rotation: 0.69,
        leftPercent: 76.39, topPercent: 81.11
      }
    },
    {
      src: ronaldo,
      className: "parrallax ronaldo",
      alt: "Cristiano Ronaldo",
      data: { 
        speedx: 0.076, speedy: 0.096, speedz: 0.98, rotation: 0.85,
        leftPercent: 90.39, topPercent: 41.66
      }
    },
  ];

  // Title data with specified values
  const titleData = { 
    speedx: 0.07, 
    speedy: 0.07, 
    speedz: 0.21, 

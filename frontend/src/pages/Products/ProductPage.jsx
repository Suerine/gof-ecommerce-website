    ...
    <section className="px-4 sm:px-6 md:px-12 lg:px-20 py-10 sm:py-14 bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            {product.images?.map((img, index) => (
              <img
                ...
                className={`
                  ...
                  object-cover cursor-pointer rounded border flex-shrink-0
        ...
        <div className="max-w-lg">
          ...
          <p className="text-2xl font-medium mb-8">KSh {product.price}</p>

          {/* SIZE SELECTOR */}
          <div className="mb-8">
            <p className="font-small mb-3">Select Size</p>
            <div className="grid grid-cols-4 sm:grid-cols-5 gap-3">
              {product.sizes?.map((size, index) => (
                <button
                  ...
                  className={`
                    border py-2 sm:py-3 rounded text-sm sm:text-base transition
          ...
          <button
            ...
            className="w-full py-3 bg-black border border-yellow-500 text-white uppercase tracking-widest font-semibold rounded-full transition duration-500 hover:bg-yellow-500 hover:text-black"
          >
            Add to Cart
          </button>
      ...
      <div className="mt-16 sm:mt-20">
        <h2 className="text-xl sm:text-2xl font-semibold mb-8 sm:mb-10">You May Also Like</h2>
